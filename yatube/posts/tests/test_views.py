    ...
    def test_pages_uses_correct_template(self):
        ...
        templates_pages_names = {
            ...
            reverse('posts:group_list',
                    kwargs={'slug': 't-group'}): 'posts/group_list.html',
            reverse('posts:profile',
                    kwargs={'username': 'Nameless'}): 'posts/profile.html',
